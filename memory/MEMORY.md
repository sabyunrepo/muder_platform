...
- [PR 리뷰 사전 체크리스트 + local-ci gate](feedback_pre_pr_review_checklist.md) — 최종 커밋 후 로컬 컨테이너 검증 / 신규 wire catalog 일치 / spec comment 와 구현 일치 / cross-component manual E2E / fixture serial mode
