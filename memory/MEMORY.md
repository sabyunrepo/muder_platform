...
- [Phase 19.1 Audit Review Follow-ups](project_phase19_1_progress.md) — **진행 중** PR-2c 사후 리뷰 MEDIUM 2건 + 통합 테스트 1건 정리 (PR-A strict env 제거+BuildState godoc S Med / PR-B coverage lint AST 재작성 M Low / PR-C session 통합 테스트+3+players table+PeerLeakAssert helper export M Med), 단일 wave 병렬 3 (2026-04-18 시작)
