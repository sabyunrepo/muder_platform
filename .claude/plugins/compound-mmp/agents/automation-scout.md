...
- OMC analyst/code-reviewer/critic의 책임 영역(요구 gap, 코드 품질, pre-mortem)과 겹치지 않는다 — 자동화 기회 탐지에 한정. (`architect` 토큰은 카논 X — `commands/compound-review.md` L87 정정, `critic`이 ADVERSARIAL 카논)
