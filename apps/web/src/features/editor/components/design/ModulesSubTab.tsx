              ...
              {category.modules.map((mod) => {
                ...
                return (
                  <div
                    key={mod.id}
                    role="row"
                    className={`group flex w-full items-center gap-2.5 border-l-2 px-4 py-1.5 transition-colors ${
                      isActive
                  ...
                  >
                    ...
                    <button
                      ...
                      className="truncate text-left text-xs font-medium focus:outline-none"
                    >
                      {mod.name}
                    </button>
                  </div>
